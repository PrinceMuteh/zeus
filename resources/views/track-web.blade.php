...
@section('content')
                ...
                <div class="main-track-section">
                    <div class="left-track-info ml-2">
                        ...
                        <ul class="sub-tabs2 mt-4">
                            ...
                            {{-- <li class="online-vehicles">Online vehicles
                                ({{ $cars->where('offlineStatus', 'Online')->count() }})</li>
                        ...
                        <div class="cars-section all-vehicles-sec">
                            ...
                            @foreach ($cars as $item)
                                ...
                                @endphp
                                <div class="row justify-content-betweent  pb-1" id="{{ $id }}">
                                    <div class="col">

                                        <a href="track-web/{{ $item->vehno }}">
                                            <div class="row d-flex">
                                                <div class="col-md-4">
                    ...
                    <div class="side-track-info" id = "side-track-info" >
                                    ...
                                    <h2 class="accordion-header" id="flush-headingTwo">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            <div class="mid-info">
                                                ...
                                                <span class="t2">This contains basic information on the vehicle.</span>
                                            </div>
                                        </button>
                                    </h2>
                                        ...
                                        <div class="accordion-body">
                                            <div class="info-main">
                                                ...
                                                <div class="user-info2">
                                                    ...
                                                    <div class="right-info2"> {{ 'Not Available' }} </div>
                                                </div>
                                                <div class="user-info2">
                                    ...
                                    <h2 class="accordion-header" id="flush-headingOne">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            <div class="mid-info">
                                                ...
                                                <span class="t2">This contains the basic information about the
                                                    driver</span>
                                            </div>
                                        </button>
                                    </h2>
                                    ...
                                    <h2 class="accordion-header" id="flush-headingThree">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            <div class="mid-info">
                                                ...
                                                <span class="t2">This contains the basic information about the vehicle
                                                    operation data.</span>
                                            </div>
                                        </button>
                                    </h2>
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="info-main">
                                                ...
                                                <div class="user-info2">
                                                    ...
                                                    @if ($data['vehicleLocation']->DtStatus ?? 0 == 1)
                                                ...
                                                <div class="user-info2">
                                                    ...
                                                    <div class="right-info2">{{ $data['vehicleLocation']->Miles ?? 0 / 1000 }}
                                                        KM</div>
                                                </div>
                                                <div class="user-info2">
                                                ...
                                                <div class="user-info2">
                                                    ...
                                                    <div class="right-info2">{{ $placeAddress }}
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <h2 class="accordion-header" id="flush-headingFour">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            <div class="mid-info">
                                                ...
                                                <span class="t2">This contains basic maintenance data on the
                                                    vehicle.</span>
                                            </div>
                                        </button>
                                    </h2>
                                    ...
                                    <h2 class="accordion-header" id="flush-headingFive">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            <div class="mid-info">
                                                ...
                                                <span class="t2">This contains basic information on the financial data
                                                    of the vehicle.</span>
                                            </div>
                                        </button>
                                    </h2>
    ...
    <script>
        ...
        document.getElementById('side-track-info').style.display = "none";
    ...
    <script>
        ...
        let rightSideInfo = document.querySelector('.right-track-info');
        ...
        rightArrow.addEventListener('click', () => {
            ...
            rightSideInfo.classList.toggle('adjustTrack');
        });
